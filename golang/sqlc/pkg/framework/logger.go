...
func (l *Logger) GetTraceLogger() tracelog.Logger {
...
func (l *Logger) Log(ctx context.Context, level tracelog.LogLevel, msg string, data map[string]interface{}) {
	...
	case tracelog.LogLevelTrace, tracelog.LogLevelDebug:
		l.SugaredLogger.Debug(msg, data)
	case tracelog.LogLevelInfo:
		l.SugaredLogger.Info(msg, data)
	case tracelog.LogLevelWarn:
		l.SugaredLogger.Warn(msg, data)
	case tracelog.LogLevelError:
		l.SugaredLogger.Error(msg, data)
	}
}

func (l *Logger) GetTraceLogLevel(level string) tracelog.LogLevel {
	switch level {
	case "trace":
