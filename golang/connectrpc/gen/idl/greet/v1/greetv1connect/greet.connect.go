...
import (
	...
	context "context"
	errors "errors"
	v1 "mukezhz/connectrpc/gen/idl/greet/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreetServiceName = "idl.greet.v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/idl.greet.v1.GreetService/Greet"
)

// GreetServiceClient is a client for the idl.greet.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the idl.greet.v1.GreetService service. By default,
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := v1.File_idl_greet_v1_greet_proto.Services().ByName("GreetService").Methods()
...
// Greet calls idl.greet.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the idl.greet.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/idl.greet.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idl.greet.v1.GreetService.Greet is not implemented"))
}
